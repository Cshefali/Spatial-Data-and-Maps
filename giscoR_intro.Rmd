...
<br>
Documentation for **`gisco_get_countries()`** is not available on **rdrr.io**. You may go through the function code on github to understand how the function works. [Github](https://github.com/rOpenGov/giscoR/blob/main/R/gisco_get_countries.R)  
